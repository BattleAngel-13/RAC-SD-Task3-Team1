...
#Tkinter Initialization - Making Tkinter Window
window = Tk()
window.title("Clock")
...
def remainder():
        ...
        if main_time2 == 'PM':
                ...
                main_hour = main_hour1
        if int(remainder_hour) == int(main_hour) and int(remainder_minutes) == int(main_minutes) and main_time2 == remainder_time2:
                notification.notify(
                title = title,
                message = message,
                app_icon=None,  
...
#Adding Clock Tkinter Components
...
#Adding Alarm Tkinter Components
...
#Adding Reminder Tkinter Components
